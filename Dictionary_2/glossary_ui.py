...
################################################################################
## Form generated from reading UI file 'MainWindow - untitledTHHFKV.ui'
##
...
"QPushButton:pressed{margin:1 0 0 1}")
        ...
        self.frame.setGeometry(QRect(10, 10, 461, 561))
        self.frame.setStyleSheet(u"")
        self.frame.setFrameShape(QFrame.NoFrame)
        self.gridLayoutWidget = QWidget(self.frame)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(0, 0, 461, 531))
        ...
        self.list_widget_for_cart.setMaximumSize(QSize(16777215, 300))
